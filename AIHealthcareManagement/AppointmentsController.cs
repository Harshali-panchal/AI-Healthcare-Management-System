...
namespace AIHealthcareManagement
{
    ...
    [Bind("AppointmentId,PatientId,DoctorId,AppointmentDate,AppointmentTime,ReasonForVisit")]
    Appointment appointment)
        {
            ...
            // Navigation properties are not filled from the form
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AppointmentId,PatientId,DoctorId,AppointmentDate,AppointmentTime,Status,ReasonForVisit,CreatedAt,UpdatedAt")] Appointment appointment)
        {
